		...
		<form id="create-account-form" class="space-y-4" @submit.prevent="submit">
			<div class="grid grid-cols-2 gap-3">
				...
				<p class="col-span-2 text-[11px] text-[var(--color-text-dim)] leading-relaxed">
					Your keys stay on this device and are sent directly to the trading backend over a secure
					WebSocket. Double-check the network matches the exchange the keys belong to.
				</p>
			</div>
		</form>
		<template #footer>
