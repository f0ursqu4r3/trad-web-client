...
<template>
  <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3 m-0">
    ...
    <div>
      <dt class="text-[10px] uppercase tracking-[0.04em] text-gray-500 mb-1">Action</dt>
      <dd class="m-0 text-[12px]">{{ titleCase(command.action) }}</dd>
    </div>

    <div>
      <dt class="text-[10px] uppercase tracking-[0.04em] text-gray-500 mb-1">Quantity (USD)</dt>
      <dd class="m-0 text-[12px]">{{ fmtUsd(command.quantity_usd) }}</dd>
    </div>

    <div>
      <dt class="text-[10px] uppercase tracking-[0.04em] text-gray-500 mb-1">Position Side</dt>
      <dd class="m-0 text-[12px]">{{ command.position_side }}</dd>
    </div>

    <div>
      <dt class="text-[10px] uppercase tracking-[0.04em] text-gray-500 mb-1">Context</dt>
