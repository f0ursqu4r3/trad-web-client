...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/settings/:section(profile|accounts|preferences|billing)',
  ...
  {
    path: '/admin/:section(operations|users|accounts|commerce|execution|audit|telemetry)',
  ...
  },
  {
    ...
    component: () => import('@/views/admin/UserAdminDetail.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      layout: 'control',
